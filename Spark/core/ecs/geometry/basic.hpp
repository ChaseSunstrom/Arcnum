...
struct Triangle
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity triangle_entity = _ecs.create_entity(MeshComponent("__triangle__"), MaterialComponent(material),
...
struct Square
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity square_entity = _ecs.create_entity(MeshComponent("__square__"), MaterialComponent(material),
                                                  TransformComponent(position, rotation, size));
...
struct Circle
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity circle_entity = _ecs.create_entity(MeshComponent("__circle__"), MaterialComponent(material),
                                                  TransformComponent(position, rotation, size));
...
struct Line
{
                         ...
                         const math::vec3 &end = math::vec3(1.0f))
    {
        ...
        Entity line_entity = _ecs.create_entity(MeshComponent("__line__"), MaterialComponent(material));
...
struct Cube
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity cube_entity = _ecs.create_entity(MeshComponent("__cube__"), MaterialComponent(material),
                                                TransformComponent(position, rotation, size));
...
struct Sphere
{
                         ...
                         const i32 slices = 36, const i32 stacks = 18)
    {
        ...
        Entity sphere_entity = _ecs.create_entity(MeshComponent("__sphere__"), MaterialComponent(material),
                                                  TransformComponent(position, rotation, size));
...
struct Capsule
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity capsule_entity = _ecs.create_entity(MeshComponent("__capsule__"), MaterialComponent(material),
                                                   TransformComponent(position, rotation, size));
...
struct Cone
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity cone_entity = _ecs.create_entity(MeshComponent("__cone__"), MaterialComponent(material),
                                                TransformComponent(position, rotation, size));
...
struct Cylinder
{
                         ...
                         const math::vec3 &rotation = math::vec3(0.0f), const math::vec3 &size = math::vec3(1.0f))
    {
        ...
        Entity cylinder_entity = _ecs.create_entity(MeshComponent("__cylinder__"), MaterialComponent(material),
                                                    TransformComponent(position, rotation, size));
...
template <typename T, typename... Args> Entity create_shape(Args &&...args)
{
