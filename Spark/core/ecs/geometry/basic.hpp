...
namespace Spark {
struct Triangle {
  static Entity create(const math::vec3 &position = math::vec3(0.0f),
  ...
  static Entity create(const std::string &material,
    ...
    Entity triangle_entity = _ecs.create_entity(
        MeshComponent("__triangle__"), MaterialComponent(material),
...
struct Square {
  ...
  static Entity create(const std::string &material,
    ...
    Entity square_entity = _ecs.create_entity(
        MeshComponent("__square__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Circle {
  ...
  static Entity create(const std::string &material,
    ...
    for (f32 i = 0; i < 360; i++) {
      ...
      vertices.push_back(
          Vertex(math::vec3(size.x * cos(angle), size.y * sin(angle), 0.0f)));
    }

    _mesh_manager.create("__circle__", vertices);

    Entity circle_entity = _ecs.create_entity(
        MeshComponent("__circle__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Line {
  static Entity create(const math::vec3 &start = math::vec3(0.0f),
  ...
  static Entity create(const std::string &material,
    ...
    Entity line_entity = _ecs.create_entity(MeshComponent("__line__"),
...
struct Cube {
  ...
  static Entity create(const std::string &material,
    ...
    Entity cube_entity = _ecs.create_entity(
        MeshComponent("__cube__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Sphere {
  ...
  static Entity create(const std::string &material,
    ...
    Entity sphere_entity = _ecs.create_entity(
        MeshComponent("__sphere__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Capsule {
  ...
  static Entity create(const std::string &material,
    ...
    Entity capsule_entity = _ecs.create_entity(
        MeshComponent("__capsule__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Cone {
  ...
  static Entity create(const std::string &material,
    ...
    Entity cone_entity = _ecs.create_entity(
        MeshComponent("__cone__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
...
struct Cylinder {
  ...
  static Entity create(const std::string &material,
    ...
    Entity cylinder_entity = _ecs.create_entity(
        MeshComponent("__cylinder__"), MaterialComponent(material),
        TransformComponent(position, rotation, size));
