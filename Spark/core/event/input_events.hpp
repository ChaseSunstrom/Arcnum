...
struct MouseButtonPressedEvent : public Event {
	MouseButtonPressedEvent(i32 button)
		: Event(EVENT_TYPE_MOUSE_BUTTON_PRESSED)
		, button(button) {};
	i32 button;
};
...
struct MouseButtonReleasedEvent : public Event {
	MouseButtonReleasedEvent(i32 button)
		: Event(EVENT_TYPE_MOUSE_BUTTON_RELEASED)
		, button(button) {};
	i32 button;
};
...
struct MouseScrolledEvent : public Event {
	MouseScrolledEvent(f64 x, f64 y)
		: Event(EVENT_TYPE_MOUSE_SCROLLED)
		, x(x)
		, y(y) {};
	f64 x;
	f64 y;
