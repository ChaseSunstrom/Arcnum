	...
	struct UITheme
	{
		struct ColorScheme
		{
			...
			ColorScheme() :
					...
					ImGui::GetStyle().Colors[ImGuiCol_BorderShadow]), m_frame_bg(ImGui::GetStyle().Colors[ImGuiCol_FrameBg]), m_frame_bg_hovered(
					ImGui::GetStyle().Colors[ImGuiCol_FrameBgHovered]), m_frame_bg_active(ImGui::GetStyle().Colors[ImGuiCol_FrameBgActive]), m_title_bg(
					ImGui::GetStyle().Colors[ImGuiCol_TitleBg]), m_title_bg_active(ImGui::GetStyle().Colors[ImGuiCol_TitleBgActive]), m_title_bg_collapsed(
					ImGui::GetStyle().Colors[ImGuiCol_TitleBgCollapsed]), m_menu_bar_bg(ImGui::GetStyle().Colors[ImGuiCol_MenuBarBg]), m_scrollbar_bg(
					ImGui::GetStyle().Colors[ImGuiCol_ScrollbarBg]), m_scrollbar_grab(ImGui::GetStyle().Colors[ImGuiCol_ScrollbarGrab]), m_scrollbar_grab_hovered(
					ImGui::GetStyle().Colors[ImGuiCol_ScrollbarGrabHovered]), m_scrollbar_grab_active(ImGui::GetStyle().Colors[ImGuiCol_ScrollbarGrabActive]), m_check_mark(
					ImGui::GetStyle().Colors[ImGuiCol_CheckMark]), m_slider_grab(ImGui::GetStyle().Colors[ImGuiCol_SliderGrab]), m_slider_grab_active(
					ImGui::GetStyle().Colors[ImGuiCol_SliderGrabActive]), m_button(ImGui::GetStyle().Colors[ImGuiCol_Button]), m_button_hovered(
					ImGui::GetStyle().Colors[ImGuiCol_ButtonHovered]), m_button_active(ImGui::GetStyle().Colors[ImGuiCol_ButtonActive]), m_header(
					ImGui::GetStyle().Colors[ImGuiCol_Header]), m_header_hovered(ImGui::GetStyle().Colors[ImGuiCol_HeaderHovered]), m_header_active(
					ImGui::GetStyle().Colors[ImGuiCol_HeaderActive]), m_separator(ImGui::GetStyle().Colors[ImGuiCol_Separator]), m_separator_hovered(
					ImGui::GetStyle().Colors[ImGuiCol_SeparatorHovered]), m_separator_active(ImGui::GetStyle().Colors[ImGuiCol_SeparatorActive]), m_resize_grip(
					ImGui::GetStyle().Colors[ImGuiCol_ResizeGrip]), m_resize_grip_hovered(ImGui::GetStyle().Colors[ImGuiCol_ResizeGripHovered]), m_resize_grip_active(
					ImGui::GetStyle().Colors[ImGuiCol_ResizeGripActive]), m_tab(ImGui::GetStyle().Colors[ImGuiCol_Tab]), m_tab_hovered(
					ImGui::GetStyle().Colors[ImGuiCol_TabHovered]), m_tab_active(ImGui::GetStyle().Colors[ImGuiCol_TabActive]), m_tab_unfocused(
					ImGui::GetStyle().Colors[ImGuiCol_TabUnfocused]), m_tab_unfocused_active(ImGui::GetStyle().Colors[ImGuiCol_TabUnfocusedActive]), m_plot_lines(
					ImGui::GetStyle().Colors[ImGuiCol_PlotLines]), m_plot_lines_hovered(ImGui::GetStyle().Colors[ImGuiCol_PlotLinesHovered]), m_plot_histogram(
					ImGui::GetStyle().Colors[ImGuiCol_PlotHistogram]), m_plot_histogram_hovered(ImGui::GetStyle().Colors[ImGuiCol_PlotHistogramHovered]), m_text_selected_bg(
					ImGui::GetStyle().Colors[ImGuiCol_TextSelectedBg]), m_drag_drop_target(ImGui::GetStyle().Colors[ImGuiCol_DragDropTarget]), m_nav_highlight(
					ImGui::GetStyle().Colors[ImGuiCol_NavHighlight]), m_nav_windowing_highlight(ImGui::GetStyle().Colors[ImGuiCol_NavWindowingHighlight]), m_nav_windowing_dim_bg(
					ImGui::GetStyle().Colors[ImGuiCol_NavWindowingDimBg]), m_modal_window_dim_bg(ImGui::GetStyle().Colors[ImGuiCol_ModalWindowDimBg]) { }
		} m_colors;
		...
		UITheme() :
				...
				ImGui::GetStyle().ItemInnerSpacing), m_scrollbar_size(ImGui::GetStyle().ScrollbarSize), m_scrollbar_rounding(
