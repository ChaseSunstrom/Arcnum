...
#define CLIENT_RECEIVE_TOPIC TCP_CLIENT_RECEIVE_TOPIC | UDP_CLIENT_RECEIVE_TOPIC + 1000 // +1000 to prevent conflicts with other topics
#define SERVER_RECEIVE_TOPIC TCP_SERVER_RECEIVE_TOPIC | UDP_SERVER_RECEIVE_TOPIC + 1000 // +1000 to prevent conflicts with other topics
#define API_CHANGED_EVENT_TOPIC 12
